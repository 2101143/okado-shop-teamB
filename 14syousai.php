    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <img src="img/okado_.png" style="width: 100%; object-fit: cover">
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <span class="h2">西日の中</span>
            </div>
            <div class="w-100"></div>
            <div class=" col-8 col-md-4 col-lg-3">
                <span class="h2">￥2500</span>
            </div>
        ...
        <div class="row justify-content-center m-2">
            <div class="col-12 col-md-7 col-lg-5" style="background-color: rgba(230,230,230,0.7)">
                ...
                <span class="h5" style="overflow-wrap: break-word">西日の輝き</span>
            </div>
        </div>
