        ...
        <form action="(G1-7-2)soshinkanryo.php" method="post">
            <div class="row mt-5 justify-content-center">
                <div class="col-11 col-md-8 col-lg-6 col-xl-5">
                    <div class="name" style="border: none"><h1 class="text-center">お届け先入力</div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            電話番号<input type="text" class="form-control" name="mail">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            郵便番号<input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            都道府県<input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            市区町村<input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            丁目・番地・号<input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            建物名/会社名<input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-mad-12 mt-3">
                            部屋番号<input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
