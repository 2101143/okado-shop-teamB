...
<body id="body">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 bg-secondary">
                <img src="img/okado_i06.png" style="width: 80%; object-fit: cover; margin-left: auto; margin-right: auto;">
                <p class="h4">商品名</p>
                <p class="h4">￥1000</p>
                <p class="h4">残り : 3</p>
                <p class="h4">数量 : 
