        ...
        <div class="container-fluid">
            <div class="row p-2">
                ...
                <div class="col-2 pt-1 text-center">
                    <a href="(G1-4-2)cart.php" class="text-dark"><i class="bi bi-cart3 display-6"></i></a><!--カート画面リンクの追加-->
                </div>
            </div>
        </div>
    </nav>
...
<form>
    ...
    <p id="text1"><button type="submit" class="btn btn-primary"><a href="(G1-6-2)kanryo.php" style="text-decoration:none;"> 送信</button></a></form></p>
</form>
</body>