      ...
      <div class="row">
        <div class="nav col-2 ">
          ...
          <nav class="nav_content">
            <ul class="nav_list">
              <li class="nav_item"><a href="home.html"style="text-decoration:none;"><div class="menu">>HOME</a></div></li>
              <li class="nav_item"><a href="ABOUT.html"style="text-decoration:none;"><div class="menu">>ABOUT</a></div></li>
              <li class="nav_item"><a href="CONTACT.html"style="text-decoration:none;"><div class="menu">>CONTACT</a></div></li>
              <li class="nav_item"><a href="home.html"style="text-decoration:none;"><div class="menu">>ログイン</a></div></li>
            </ul>
          </nav>
          ...
          <main>
            ...
            <div><p>
              <div class="messege-wrapper"><h5 class = "text-center col-12">こんにちは</h5><br>
              <p class="text-center" >okadoハンドメイドショップです。</p>
              </div> 
            </p>

            <ul>
              <li>Sample</li>
              <li>5th Floor aso Fukuoka Hakata</li>
