          ...
          <div class="nav col-2 ">
            ...
            <nav class="nav_content">
              <ul class="nav_list">
                ...
                <li class="nav_item"><a href="home.php"style="text-decoration:none;"><div class="menu">>ログイン</a></div></li>
              </ul>
            </nav>
...
<div name="maindiv" >
	...
	<style>
        ...
        <div class="form-check form-check-inline">
            <input type="radio" name="num_of_inq" value="card">はじめて
        ...
        <br>
        <div class="form-check form-check-inline">
            <input type="radio" name="num_of_inq" value="konbini">
            <label class="form-check-label" for="chk1">コンビニ決済</label>
        </div>
        <br>
        <div class="form-check form-check-inline">
            <input type="radio" name="num_of_inq" value="daibiki">
